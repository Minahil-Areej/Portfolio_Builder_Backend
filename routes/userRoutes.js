...
router.get('/', async (req, res) => {
  try {
    const users = await User.find({})
      .populate('assignedAssessor', 'name email') // Populate assessor details
      .select('name email role isActive assignedAssessor createdAt'); // Include assignedAssessor in selection
